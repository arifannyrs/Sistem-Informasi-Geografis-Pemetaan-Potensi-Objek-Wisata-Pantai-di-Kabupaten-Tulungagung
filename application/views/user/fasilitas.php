...
<div id="main">
    ...
    <article class="post">
            ...
            <div class="title">
                ...
                <div class="col-6 col-12-xsmall">
                    <select name="demo-category" id="demo-category" onchange="location = this.value;">
                        ...
                        <option value="<?= site_url('peta/keindahan')?>">Keindahan Pantai</option>
                        <option value="<?= site_url('peta/fasilitas')?> " selected="selected">Fasilitas</option>
        ...
        <div id="mapid"></div>
        <br>Berdasarkan hasil penilaian, maka Pantai Brumbun sebagai kandidat yang terpilih berdasarkan
        Fasilitas yang lengkap seperti Toilet, Mushola, Warung, Spot foto.</br>
    </article>

    <ul class="actions pagination">
        <li><a href="<?= site_url('peta/keindahan')?>" class="button next">Keindahan Pantai</a></li>
        <li><a href="<?= site_url('peta/akses')?>" class="button next">Akses</a></li>
    </ul>
