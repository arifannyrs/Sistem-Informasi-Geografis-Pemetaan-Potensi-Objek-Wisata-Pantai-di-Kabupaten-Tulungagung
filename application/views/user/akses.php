...
<div id="main">
    ...
    <article class="post">
            ...
            <div class="title">
                ...
                <div class="col-6 col-12-xsmall">
                    <select name="demo-category" id="demo-category" onchange="location = this.value;">
                        ...
                        <option value="<?= site_url('peta/akses')?>" selected="selected">Akses</option>
                    </select>
                </div>
            </div>
        </header>
        ...
        kemudahan akses menuju lokasi dengan dapat ditempuh menggunakan sepeda motor maupun mobil.</br>
    </article>

    <ul class="actions pagination">
        <li><a href="<?= site_url('peta/fasilitas')?>" class="button next">Fasilitas</a></li>
        <li><a href="" class="disabled button previous">Akses</a></li>
    </ul>
