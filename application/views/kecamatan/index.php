            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-block">
                        ...
                        <div class="card-subtitle"><?= anchor('kecamatan/tambah', 'Tambah Data', 'class="btn btn-primary"') ?></div>
                                ...
                                <tbody>
                                    <?php foreach ($kecamatan as $row) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= site_url('kecamatan/ubah/' . $row->id_kecamatan) ?>" class="btn btn-success btn-xs" title="Ubah">Ubah</a>
                                                <a href="#" data-href="<?php echo site_url('kecamatan/hapus/' . $row->id_kecamatan); ?>" data-toggle="modal" data-target="#confirm-delete" class="btn btn-danger btn-xs" title="Hapus">Hapus</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
