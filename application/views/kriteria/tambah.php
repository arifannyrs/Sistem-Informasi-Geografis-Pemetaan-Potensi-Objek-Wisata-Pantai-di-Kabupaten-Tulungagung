                ...
                <div class="card">
                    <div class="card-block">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text" name="kode_kriteria" class="form-control form-control-line" value="<?= set_value('kode_kriteria') ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text" name="nama_kriteria" class="form-control form-control-line" value="<?= set_value('nama_kriteria') ?>">
