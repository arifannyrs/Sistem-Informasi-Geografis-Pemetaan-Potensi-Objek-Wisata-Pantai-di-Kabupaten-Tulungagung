    ...
    public function prioritas()
    {
        ...
        if (isset($_POST['check'])) {
            ...
            if ($this->ahp_uji_konsistensi($hasil_tabel_konsistensi)) {
                ...
                // update id_nilai dari pantai_kriteria
                $this->load->model('pantai_kriteria_model');
                $pantai_kriteria = $this->pantai_kriteria_model->get_all_pantai_kriteria()->result();
                foreach ($pantai_kriteria as $row) {
                    $params = array(
                        'id_nilai' => $this->get_id_nilai($row->nilai),
                    );
                    $this->pantai_kriteria_model->update_by_id($row->id, $params);
                }
            } else {
